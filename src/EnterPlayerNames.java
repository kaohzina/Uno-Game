...
public class EnterPlayerNames {//controller for EnterPlayerNames.fxml
    ...
    @FXML private Pane EnterPlayerNamePane;
...
//   private TextField pidTextBox;
    ...
    //Creating array list for users names to be input as players 1-4
    ArrayList<String> playerIds = new ArrayList<String>();
	//Name Spaces on "Enter Player Names" slide.
    
    public String[] getPlayerIDs() {//takes array list playerIDs created above, converting to array, making sure array size fits. 
